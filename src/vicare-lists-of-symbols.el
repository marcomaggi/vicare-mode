...
;; Time-stamp: <2016-04-23 09:19:58 marco>
...
;;The following regexps are used to build `vicare-identifier-rex' and
;;their  hierarchy  comes  directly  from  the  R6RS  document,  Section
;;"Lexical syntax", Subsection "Formal account".

(defconst vicare-identifier-constituent-rex
  "[a-zA-Z]")

(defconst vicare-identifier-special-initial-rex
  ;;;"[\\!\\$%\\&\\*/:<=>\\?^_~]")
  "[!$%&*/:<=>?^_~]")

(defconst vicare-identifier-inline-hex-escape-rex
  "\\x[0-9a-fA-F]+;")

(defconst vicare-identifier-initial-rex
  (concat "\\(?:" vicare-identifier-constituent-rex
	  "\\|" vicare-identifier-special-initial-rex
	  "\\|" vicare-identifier-inline-hex-escape-rex
	  "\\)"))
...
(defconst vicare-identifier-subsequent-rex
  (concat "\\(?:" vicare-identifier-initial-rex
	  "\\|" "[0-9]+"
	  "\\|" vicare-identifier-special-subsequent-rex
	  "\\)"))

(defconst vicare-identifier-peculiar-identifier-rex
  (concat "\\(?:" "\\+"
	  "\\|" "\\-"
	  "\\|" "\\.\\.\\."
	  "\\|" "\\->" "\\(?:" vicare-identifier-subsequent-rex "\\)*"
	  "\\)"))

(defconst vicare-identifier-internal-rex
  (concat "\\(?:"
	  "\\(?:" vicare-identifier-initial-rex
	  "\\(?:" vicare-identifier-subsequent-rex "\\)*" "\\)"
	  "\\|"
	  vicare-identifier-peculiar-identifier-rex
	  "\\)")
...
(defconst vicare-r6rs-functions-list
  '("+" "*" "-" "/" "<" ">" "<=" ">=" "=" "!="
    "abs"
    "acos"
    "angle"
...

;;;; lists of custom vicare symbols
;;
...
(defconst vicare-vicare-syntaxes-list
  '("begin0" "receive" "receive-and-return" "module" "include" "xor"
    ...
    "type-annotation-super-and-sub?" "type-annotation-common-ancestor" "type-annotation-ancestors" "type-annotation-union"
...
(defconst vicare-clos-functions-list
  '("add-method"
...
;;; vicare-lists-of-symbols.el ends here
;; Local Variables:
;; coding: utf-8-unix
;; End:
